...
mix.js(`${__dirname}/resources/assets/admin/js/main.js`, `${__dirname}/assets/admin/js/storefront.js`)
    ...
    .copy(`${__dirname}/resources/assets/public/js/plugins.js`, `${__dirname}/assets/public/js/plugins.js`)
    .copy(`${__dirname}/node_modules/bootstrap-icons/font/fonts`, `${__dirname}/assets/public/css/fonts`)
